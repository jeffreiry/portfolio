# Méliuz · Product Designer Sr

**Empresa:** Méliuz  
**Produto:** Plataforma de cashback e shopping (43M usuários)  
...
|---|---|---|
| Experiência prévia em área de shopping | 0 | Ausente |
| Soluções baseadas em AI | 3 | Enterprise AI case — bem evidenciado e central no portfolio |
| Construção e/ou desenvolvimento de Design Systems | 2 | Power Apps e Cartela Cores evidenciam DS; não é o foco principal de nenhum case |
...
- End-to-end com ownership claramente evidenciado em múltiplos cases
- AI como competência — Enterprise AI é o diferencial de destaque para vaga consumer de tecnologia
...
Somos uma marca global, certificada pelo ranking GPTW e comprometida em criar produtos, serviços e parcerias alinhadas à nossa Cultura. Estendemos o compromisso às pessoas colaboradoras, investindo no desenvolvimento e satisfação das pessoas.

Quer ver o seu trabalho impactar a vida de mais de 43 milhões de pessoas usuárias, atuar de qualquer parte do Brasil com horários flexíveis e outros benefícios exclusivos?

### Responsabilidades e atribuições

- Projetar conceitos, wireframes, fluxos, jornadas e interfaces para experiências web e mobile
- Construir e evoluir Design System escaláveis para experiências web e mobile
- Criar protótipos navegáveis para validação com stakeholders e testes com usuários
- Conduzir entrevistas e testes de usabilidade, transformando insights em melhorias acionáveis
- Colaborar com Product Managers, Engenheiros, Designers e Researchers em times multidisciplinares
- Identificar problemas de usabilidade e traduzir o ponto de vista do usuário na realização de melhorias na experiência
- Colaborar na construção e consolidação da experiência do usuário em nossos produtos
- Atuar de ponta a ponta (end-to-end), com forte senso de ownership desde discovery até delivery

### Requisitos e qualificações

- Desejável formação (graduação, curso ou pós) em Design
- Experiência comprovada em design de produtos digitais
- Portfólio com projetos que atravessem diferentes etapas do processo de design
- Habilidade para resolver problemas de forma organizada, criativa e orientada a resultados
- Experiência em softwares de design e prototipação (Figma)
- Experiência em pesquisa com usuários, testes de usabilidade e/ou dinâmicas de cocriação
- Experiência com E-commerce e/ou Checkout, Shopping, Produtos Financeiros, Aquisições Orgânicas e Growth
- Nível de leitura básica em inglês

### Você vai se destacar se tiver

- Experiência prévia na área de shopping
- Experiência com construção de soluções baseadas em AI
- Experiência na construção e/ou desenvolvimento de Design Systems
