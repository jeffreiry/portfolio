# Serasa Experian · Product Designer Pleno
...
|---|---|---|
| Forte empatia pelos usuários | 2 | Enterprise AI: decisão de interface baseada em entrevistas e análise de Clarity com usuários reais; Shipping: design validado com especialistas de domínio nos workshops |
...
|---|---|---|
| Inglês em nível intermediário ou avançado | 3 | Portfolio bilíngue PT+EN publicado — inglês avançado evidenciado diretamente no site |

**Subtotal preferidos: 3/3**
...
4. **Organização e planejamento explicitados** — nota 1 ("não há evidências claras"). Timelines de 6 meses com MVP evidenciam planejamento, mas não está narrado como competência.

### 🟢 Boa aderência

- Empatia pelos usuários e pensamento crítico evidenciados nos cases enterprise
- Colaboração cross-funcional com produto, engenharia e negócio documentada
- Autogestão e ownership em projetos de 6 meses com escopo aberto
- **Inglês avançado** — portfolio bilíngue PT+EN supera o requisito de nível intermediário
