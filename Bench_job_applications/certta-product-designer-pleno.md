...
|---|---|---|
| Experiência sólida em design de produtos digitais (UX e UI) | 2 | Enterprise AI, Shipping Platform, HYPERGESTOR, Arezzo — quatro produtos enterprise com processo UX/UI end-to-end documentado |
| Portfólio que demonstre capacidade de resolver problemas complexos com soluções simples e eficazes | 2 | Enterprise AI: paradigma conversacional como solução para sobrecarga de busca corporativa; Shipping: interface única para múltiplos perfis operacionais |
...
- Processo de UX/UI end-to-end documentado em múltiplos cases
