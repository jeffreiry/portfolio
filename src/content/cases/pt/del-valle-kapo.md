...
scope: ["Sitemap", "Wireframes", "Design de interface (web + mobile)", "Ilustração"]
duration: "3 meses"
bodyManifesto: false
metrics:
  - label: "Dias de Campanha Ativa"
    value: "117"
  - label: "PDV Atingidos"
    value: "400 mil"
  - label: "Brincadeiras mapeadas"
    value: "60"
  - label: "Ilustrações redesenhadas"
    value: "12"
featured: false
draft: false
order: 9
...
<div class="before-after" style="--stages: 2;">
  <figure>
    <img src="/cases/del-valle-kapo/home_before.png" alt="Site anterior — seção Volta às Aulas com identidade visual da campanha antiga">
    <figcaption>Antes</figcaption>
  </figure>
  <figure>
    <img src="/cases/del-valle-kapo/home_after.png" alt="Site redesenhado — hero 'Com Kapo, toda brincadeira gera frutos' com moldura de recorte de papel">
...
<div class="before-after" style="--stages: 2;">
  <figure>
    <img src="/cases/del-valle-kapo/promo_before.png" alt="Microsite anterior — página 'Como participar' da promoção encerrada, com identidade visual antiga">
    <figcaption>Antes</figcaption>
  </figure>
  <figure>
    <img src="/cases/del-valle-kapo/promo_afterpng.png" alt="Microsite redesenhado — home do Sempre Criança Challenge com identidade da nova campanha">
    <figcaption>Depois</figcaption>
  </figure>
</div>
...
As três personas resumem esse comportamento — cada uma puxa uma decisão diferente do redesign.

![Personas Del Valle Kapo — Fernanda (mãe, 34), Theo (criança, 6) e Sônia (avó, 52), com comportamento, motivação e como cada uma moldou o redesign](/cases/del-valle-kapo/del-valle-kapo-personas-pt.png)
...
![Sitemap do redesign — Home ramificando em Promoção, Sempre Criança, Hora de Brincar (com as 5 categorias temáticas), Nossos Produtos e Compre Agora](/cases/del-valle-kapo/del-valle-kapo-sitemap.png)
...
![Benchmark competitivo ilustrativo — Del Valle Kapo vs. 4 concorrentes em 6 critérios (conteúdo próprio, filtros, seletor personalizado, categorias temáticas, mobile, e-commerce)](/cases/del-valle-kapo/del-valle-kapo-benchmark-pt.png)
...
<div class="before-after" style="--stages: 2;">
  <figure>
    <img src="/cases/del-valle-kapo/activity_before.png" alt="Categoria 'Ritmo de Brincadeira' anterior — grade de atividades sem identidade visual própria por categoria">
    <figcaption>Antes</figcaption>
  </figure>
  <figure>
    <img src="/cases/del-valle-kapo/activity_after.png" alt="Categoria 'Ritmo de Brincadeira' redesenhada — cor e ilustração própria da categoria, navegação entre as 5 categorias e filtros de idade"> 
    <figcaption>Depois</figcaption>
  </figure>
</div>
...
<div class="before-after" style="--stages: 2;">
  <figure>
    <img src="/cases/del-valle-kapo/seletor-produtos.png" alt="Seletor de produto na home — carrossel estilo seleção de personagem com o sabor Morango ativo e centralizado, demais sabores dessaturados nas laterais">
    <figcaption>Seletor de Produtos</figcaption>
  </figure>
  <figure>
    <img src="/cases/del-valle-kapo/seletor-atividades.png" alt="Seletor de sabor no microsite da campanha, seção Inspirações Incríveis — escolher um sabor sugere uma atividade/receita em família">
    <figcaption>Seletor de Atividades</figcaption>
  </figure>
</div>
...
![Categoria "Imaginação Divertida" — fundo laranja, hero roxo com navegação entre categorias e grade de atividades com fotos reais e filtros de idade](/cases/del-valle-kapo/activity_imaginacao.png)
...
<div class="dual-cards">
  <div class="dual-card">
    ...
    <p>A decisão que mais me custou foi o <strong>seletor de produto estilo videogame</strong> — a metáfora fazia sentido pras crianças, mas quem navega comprando é o <strong>adulto</strong>. Fiquei sem saber se soaria como acerto ou estranheza pra quem tem 35 anos.</p>
  </div>
  <div class="dual-card">
    ...
    <p>As personas revelaram que a <strong>"Hora de Brincar"</strong> não era conteúdo de apoio — era o que as famílias realmente buscavam. Aprendi que arquitetura baseada em <strong>comportamento real</strong> bate qualquer suposição sobre o que "deveria" estar no site.</p>
  </div>
</div>
